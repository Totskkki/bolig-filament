                    ...
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <div class="text-sm text-gray-500 dark:text-gray-400">
                                ...
                                Collected: <span class="font-semibold text-gray-700 dark:text-gray-200">₱{{ number_format($group->total_collected_amount, 2) }}
</span>
                            </div>
                            <div class="mt-1">
        ...
        <x-slot name="content">
            ...
            @if ($selectedDeceasedId)
                <form wire:submit.prevent="uploadReceipt" class="mt-3 space-y-2" enctype="multipart/form-data">
                    <div>
                        <label class="block mb-1 text-sm font-medium text-gray-700 dark:text-gray-300">Upload Receipt</label>
                        <input
                            type="file"
